...
int main() {
  ...
  //     layer(cur_input + sizeof(double) *start_idx, outputs[i]+ sizeof(double)
  //     *start_idx, weights[i]+ sizeof(double) *start_idx, biases[i]+
  //     sizeof(double) *start_idx, input_size, neuron_num_split);
